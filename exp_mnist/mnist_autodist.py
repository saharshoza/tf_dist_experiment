from tensorflow.python.client import autodist
...
def main(_):
  ...
  ad = AutoDist(FLAGS.config_file, FLAGS.address)
  ad.start()
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      ...
      type=str,
      default="",
      help="Path to config file of the cluster"
  )
